...
- `CURSOR.md` + `NOVELVIZ_REFERENCE_v10.md` maintained as persistent context
...
- Reference doc is now `NOVELVIZ_REFERENCE_v10.md` — update `CURSOR.md` to point at the new version
