...
**Key libraries:** `@anthropic-ai/sdk`, `openai`, `@fal-ai/client`, `cloudinary`, `@clerk/nextjs`, `@prisma/adapter-neon`, `jszip`, `fast-xml-parser`, `react-markdown`, `recharts`, `react-calendar`, `i18n-iso-countries`
